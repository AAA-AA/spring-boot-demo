...
public class JedisClusterDemo {
    ...
    public static void main(String[] args) throws IOException {
        HostAndPort ip_port_pair = new HostAndPort("127.0.0.1",7001);
        HostAndPort ip_port_pair2 = new HostAndPort("127.0.0.1",7002);
        HostAndPort ip_port_pair3 = new HostAndPort("127.0.0.1",7003);
